	...
	<view>
		<view class="container">
			<view class="slide-box" v-for="(item, index) in listData" :key="index">
				...
				>
					<view class="now-message-info" hover-class="uni-item--hover" :style="{ width: windowWidth + 'px' }" @click="clickItemMethod(item.id)">
						<image class="icon-image" v-if="item.img" :src="item.img"></image>
						...
						<view class="list-right">
							...
							<view class="list-detail" v-if="item.msg">{{ item.msg }}</view>
						</view>
						<view class="list-right-1" v-if="item.sendTime">{{ item.sendTime }}</view>
					</view>
