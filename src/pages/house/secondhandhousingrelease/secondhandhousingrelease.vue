	...
	<!-- 创建房源信息-->
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType" v-if="showview">
			...
			<u-form-item :label-position="labelPosition" label="产权性质" prop="coun" label-width="150" color="#a0cfff">
				<u-input :border="border" type="select" :select-open="selectShow7" v-model="model.coun" placeholder="请选择产权性质" @click="selectShow7 = true"></u-input>
			</u-form-item>
			...
			<u-form-item :label-position="labelPosition" label="唯一住房" prop="zuf" label-width="150" color="#a0cfff">
				<u-input :border="border" type="select" :select-open="selectShow5" v-model="model.zuf" placeholder="请选择唯一住房" @click="selectShow5 = true"></u-input>
			</u-form-item>
					...
					if (valid) {
						...
						uni.uploadFile({
						  ...
						  addSecondHand({
						  	...
						  	"propertyRightId":this.model.deposit,//押金
