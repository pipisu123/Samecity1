			...
			<view class="rbag_con hidden">
				<view class="rbag_top">
					<view class="rbag_top_info">
						<image class="rbag_logo" src="https://thirdwx.qlogo.cn/mmopen/vi_32/YQIxj616l4vev5RicB60oquMVSTbNccMDAgSY5hPaoDAH4oGViad6kGGeJj75Q0ljAPtFMAUKB7DFxrpG6jEnEYw/132" mode=""></image>
