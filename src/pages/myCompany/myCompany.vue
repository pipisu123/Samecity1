<template>
	<view class="page" v-if="companyId!='0'">
		<view class="wrap">
			<u-row gutter="16">
				<u-col span="10">
				...
				<u-col span="2">
					<view class="demo-layout bg-purple-dark">
						<u-avatar :src="'http://192.168.101.24:8080/'+company.logo_picture_path" mode="square"></u-avatar>
					</view>
				</u-col>
			</u-row>
		</view>
	...
	<view v-else>
		...
		<view class="create">
			<u-button type="primary" @click="toCreateCompany">点击前往创建简历</u-button>
		</view>
	</view>
</template>
		...
		methods: {
			...
			async getmyCompany(companyId) {
				findCompany({
					...
					this.html = res.data.data.companys[0].company_introduction
			...
			toCreateCompany(){
				uni.navigateTo({
					url:'../CreateCompany/CreateCompany'
				})
			},
			// 跳转到修改公司信息
