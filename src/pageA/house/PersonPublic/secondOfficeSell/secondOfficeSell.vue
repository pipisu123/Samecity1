	...
	<view>
		...
		<view class="" v-else>
			...
			<view class="bottom-nav">
				<u-button type="primary" @click="addEstate" throttle-time=3000>添加楼盘(如未搜索出添加即可)</u-button>
			</view>
		</view>
	</view>
</template>
											...
											addOfficeSecondHandByPerson({
												...
												if (res.data.code === 0) {
													setTimeout(() => {
														uni.hideLoading()
														uni.reLaunch({
															url: '/pageA/house/mypage/myOfficeList/myOfficeList'
														})
													}, 1500);
												} else {
