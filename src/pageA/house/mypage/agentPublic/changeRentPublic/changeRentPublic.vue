		...
		<view class="content" v-if="showview">
			<view style="padding: 10rpx;">
				<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
					...
					<u-form-item :leftIconStyle="{color: '#888', fontSize: '16rpx'}" label-width="130" :label-position="labelPosition"
					 label="转让费" prop="rentFreeMonth">
						<view style="display: flex;">
							<view style="width: 98%;">
								<u-input :border="border" placeholder="请输转让费" v-model="model.rentFreeMonth" type="text"></u-input>
							</view>
							<text>元</text>
						</view>
					</u-form-item>
...
<script>
	...
	import { addShopSubletByBroker } from '@/util/house/shop.js'
	import {
		findAllEstateByCity
											...
											addShopSubletByBroker({
												...
												if (res.data.code === 0) {
													setTimeout(() => {
														uni.hideLoading()
														uni.reLaunch({
															url: '/pageA/house/mypage/agentPublic/myShopPublicList/myShopPublicList'
														})
													}, 1500);
												} else {
