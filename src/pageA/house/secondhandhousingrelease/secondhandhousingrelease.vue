...
<script>
	...
	export default {
		...
		methods: {
			...
			radioChange(e) {
				if (e == '有') {
					this.model.elevator = 1
				} else {
					this.model.elevator = 0
				}
			},
						...
						uni.uploadFile({
							...
							success: (res) => {
								...
								addSecondHand({
									...
									"elevator": this.model.elevator, //电梯
									...
									if (res.data.code === 0) {
										setTimeout(() => {
											uni.hideLoading()
											uni.reLaunch({
												url: '/pageA/house/mypage/mySecHouseList/mySecHouseList'
											})
										}, 1500);
									} else {
			...
			selectConfirm2(e) {
				console.log(e)
				this.model.industry = '';
				this.model.roomNum = e[0].value
				this.model.hallNum = e[1].value
