<template>
	<view>
		...
		<view class="center-bar">
			<Dropdown :itemArr="itemArr" :listArr="listArr" @subItemClick="subItemClick" @itemClick="itemClick"
			 :isShowMore="isShowMore"></Dropdown>
		</view>
		<rentOfficeList :houseList="houseList"></rentOfficeList>
	</view>
</template>

<script>
	import rentOfficeList from '../childComps/rentOfficeList.vue'
	import Dropdown from '@/pageA/house/common/dropdown-screen.vue'
	
	import { officeLeaseQuery } from '@/util/house/searchHouse.js'
	import {
