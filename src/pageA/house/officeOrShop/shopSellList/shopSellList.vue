<template>
	<view>
		<view class="searchbar">
			...
			<view class="seach">
				<u-search placeholder="输入商铺信息？" @search="search1" v-model="content" @custom="custom"></u-search>
			</view>
		</view>
		...
		<sellShopList :houseList="houseList"></sellShopList>
	</view>
</template>

<script>
	import sellShopList from '../childComps/sellShopList.vue'
	import Dropdown from '@/pageA/house/common/dropdown-screen.vue'
	
	import { shopSecondHandQuery } from '@/util/house/searchHouse.js'
	import {
